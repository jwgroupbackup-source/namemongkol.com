...
export const metadata: Metadata = {
    title: 'ตั้งชื่อมงคล ตั้งชื่อลูก 2569 ฟรี! รวม 5,000+ ชื่อเกรด A+ | NameMongkol',
    alternates: { canonical: `${siteUrl.replace(/\/$/, '')}/search` },
    description: 'ตั้งชื่อมงคล ตั้งชื่อลูกชาย ตั้งชื่อลูกสาว 2569 ฟรี! ค้นหาชื่อมงคลกว่า 5,000 ชื่อ คัดเกรด A+ ความหมายดี หลีกเลี่ยงกาลกิณี กรองตามวันเกิด เพศ ผลรวมเลขศาสตร์ เปลี่ยนชื่อเสริมดวงก็ได้',
    ...
    openGraph: {
        title: 'ตั้งชื่อมงคล ตั้งชื่อลูก 2569 ฟรี! รวม 5,000+ ชื่อ | NameMongkol',
        description: 'ตั้งชื่อมงคล ตั้งชื่อลูกชาย ตั้งชื่อลูกสาว 2569 ฟรี! ชื่อเกรด A+ ความหมายดี หลีกเลี่ยงกาลกิณี กรองตามวันเกิด',
        url: `${siteUrl}/search`,
    ...
    twitter: {
        ...
        title: 'ตั้งชื่อมงคล ตั้งชื่อลูก 2569 ฟรี! รวม 5,000+ ชื่อ | NameMongkol',
        description: 'ตั้งชื่อลูกชาย ตั้งชื่อลูกสาว 2569 ฟรี! รวมชื่อมงคลเกรด A+ กว่า 5,000 ชื่อ',
...
export default function SearchPage() {
    ...
    const jsonLd = {
        ...
        '@type': 'WebApplication',
        'name': 'ตั้งชื่อมงคล ตั้งชื่อลูก ฟรี - NameMongkol',
        'alternateName': 'NameMongkol Free Auspicious Name Search',
        'description': 'ระบบตั้งชื่อมงคล ตั้งชื่อลูกฟรี รวมกว่า 5,000 ชื่อที่คัดสรรแล้ว เหมาะสำหรับตั้งชื่อลูกชาย ลูกสาว และเปลี่ยนชื่อใหม่',
        'url': `${siteUrl}/search`,
