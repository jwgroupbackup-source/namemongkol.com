...
export async function generateMetadata(
  ...
  if (!name) {
    return {
      title: 'วิเคราะห์ชื่อ ฟรี! ตั้งชื่อมงคล เปลี่ยนชื่อเสริมดวง 2569 | NameMongkol',
      description: 'วิเคราะห์ชื่อ นามสกุล ฟรี! วิเคราะห์ชื่อมงคล ตั้งชื่อลูก เปลี่ยนชื่อใหม่ ด้วยระบบ AI ผสาน 4 ศาสตร์ เลขศาสตร์ ทักษาปกรณ์ อายตนะ 6 นิรันดร์ศาสตร์ เช็คพลังเงา ผลรวมชื่อ อักษรกาลกิณี แม่นยำ น่าเชื่อถือ',
      keywords: 'วิเคราะห์ชื่อ, วิเคราะห์ชื่อมงคล, วิเคราะห์ชื่อฟรี, วิเคราะห์ชื่อ นามสกุล ฟรี, วิเคราะห์ชื่อ 2569, เปลี่ยนชื่อมงคล, ชื่อมงคล, ดูดวงชื่อ, ผลรวมเลขศาสตร์, อักษรกาลกิณี, เลขศาสตร์, ทักษาปกรณ์, อายตนะ 6, นิรันดร์ศาสตร์, NameMongkol',
      alternates: { canonical: canonicalUrl },
      openGraph: {
        title: 'วิเคราะห์ชื่อ ฟรี! ตั้งชื่อมงคล เปลี่ยนชื่อเสริมดวง 2569 | NameMongkol',
        description: 'วิเคราะห์ชื่อ นามสกุล ฟรี! วิเคราะห์ชื่อมงคล ตั้งชื่อลูก ด้วยระบบ AI ผสาน 4 ศาสตร์ เลขศาสตร์ ทักษาปกรณ์ อายตนะ 6 นิรันดร์ศาสตร์ เช็คพลังเงา ผลรวมชื่อ อักษรกาลกิณี',
        images: [{
          ...
          width: 1200,
          height: 630,
          alt: 'วิเคราะห์ชื่อ ฟรี ด้วย AI ผสาน 4 ศาสตร์ - NameMongkol',
          type: 'image/png',
        }],
      ...
      twitter: {
        ...
        title: 'วิเคราะห์ชื่อ ฟรี! ตั้งชื่อมงคล เปลี่ยนชื่อเสริมดวง 2569 | NameMongkol',
        description: 'วิเคราะห์ชื่อ นามสกุล ฟรี! วิเคราะห์ชื่อมงคล ตั้งชื่อลูก ด้วย AI ผสาน 4 ศาสตร์ เช็คพลังเงา ผลรวมชื่อ อักษรกาลกิณี',
        images: [{
          url: `${siteUrl}/api/og?variant=default`,
          width: 1200,
          height: 630,
          alt: 'วิเคราะห์ชื่อ ฟรี - NameMongkol',
        }],
      },
    ...
    '@graph': [
      {
        ...
        'url': 'https://www.namemongkol.com',
        'name': 'NameMongkol',
        'description': 'วิเคราะห์ชื่อ ตั้งชื่อมงคล ตั้งชื่อลูก เปลี่ยนชื่อเสริมดวง ด้วยระบบ AI ผสาน 4 ศาสตร์',
        'inLanguage': 'th-TH',
        'potentialAction': {
          '@type': 'SearchAction',
      ...
      },
      {
        ...
        'url': 'https://www.namemongkol.com',
        'name': 'วิเคราะห์ชื่อ ฟรี! ตั้งชื่อมงคล เปลี่ยนชื่อเสริมดวง 2569 | NameMongkol',
        'isPartOf': { '@id': 'https://www.namemongkol.com/#website' },
        'description': 'วิเคราะห์ชื่อ นามสกุล ฟรี! วิเคราะห์ชื่อมงคล ตั้งชื่อลูก ด้วยระบบ AI ผสาน 4 ศาสตร์',
        'inLanguage': 'th-TH',
        'primaryImageOfPage': {
          '@type': 'ImageObject',
