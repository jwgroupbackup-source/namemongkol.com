...
export async function generateMetadata(
  ...
  if (!name) {
    return {
      ...
      keywords: 'วิเคราะห์ชื่อ, วิเคราะห์ชื่อมงคล, วิเคราะห์ชื่อฟรี, วิเคราะห์ชื่อ นามสกุล ฟรี, ตั้งชื่อมงคล, วิเคราะห์ชื่อ 2569, ตั้งชื่อลูก 2569, เปลี่ยนชื่อ, ชื่อมงคล, ดูดวงชื่อ, เลขศาสตร์, ทักษาปกรณ์, อายตนะ 6, NameMongkol',
