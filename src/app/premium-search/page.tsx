...
export const metadata: Metadata = {
    ...
    description: 'บริการค้นหาชื่อมงคล Pro จากฐานข้อมูลกว่า 1,172 ชื่อที่คัดสรรแล้ว การันตีไม่มีอักษรกาลกิณี เลือกเน้นเสริมดวงการงาน การเงิน หรือความรักได้เฉพาะเจาะจง เหมาะสำหรับตั้งชื่อ/เปลี่ยนชื่อแบบจริงจัง ตามหลักทักษาและเลขศาสตร์',
    keywords: ['ค้นหาชื่อมงคล Pro', 'ชื่อมงคลพรีเมียม', 'เปลี่ยนชื่อมงคล', 'เปลี่ยนชื่อเสริมดวง', 'วรรคเดช', 'วรรคศรี', 'ผลรวมเลขศาสตร์', 'อักษรนำ', 'ชื่อมงคลขั้นสูง', 'ตัวกรองชื่อ', 'ชื่อเสริมดวง', 'ชื่อคัดพิเศษ'],
