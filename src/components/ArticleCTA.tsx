...
export const ArticleCTA = () => {
    return (
        <div className="my-8">
            ...
            <Link href="/name-check" className="group relative overflow-hidden rounded-xl bg-[#0f172a] border border-amber-500/50 hover:border-amber-400 transition-[transform,border-color,box-shadow] hover:-translate-y-1 hover:shadow-xl shadow-md p-5">
                <div className="flex items-start justify-between">
                    <div>
                        ...
                        <p className="text-slate-300 text-xs mb-0 line-clamp-2">
            ...
            <Link href="/name-analysis" className="group relative overflow-hidden rounded-xl bg-[#0f172a] border border-[#1e293b] hover:border-indigo-500/50 transition-[transform,border-color,box-shadow] hover:-translate-y-1 hover:shadow-xl shadow-md p-5">
                <div className="flex items-start justify-between">
                    <div>
            ...
            <Link href="/premium-analysis" className="group relative overflow-hidden rounded-xl bg-[#0f172a] border border-[#1e293b] hover:border-purple-500/50 transition-[transform,border-color,box-shadow] hover:-translate-y-1 hover:shadow-xl shadow-md p-5">
                <div className="flex items-start justify-between">
                    <div>
            ...
            {/* Wallpapers Card */}
            <Link href="/wallpapers" className="group relative overflow-hidden rounded-xl bg-[#0f172a] border border-[#1e293b] hover:border-amber-500/50 transition-[transform,border-color,box-shadow] hover:-translate-y-1 hover:shadow-xl shadow-md p-5">
                <div className="flex items-start justify-between">
                    <div>
            ...
            {/* Phone Analysis Card */}
            <Link href="/phone-analysis" className="group relative overflow-hidden rounded-xl bg-[#0f172a] border border-[#1e293b] hover:border-emerald-500/50 transition-[transform,border-color,box-shadow] hover:-translate-y-1 hover:shadow-xl shadow-md p-5">
                <div className="flex items-start justify-between">
                    <div>
            ...
            <Link href="/search" className="group relative overflow-hidden rounded-xl bg-[#0f172a] border border-[#1e293b] hover:border-amber-500/50 transition-[transform,border-color,box-shadow] hover:-translate-y-1 hover:shadow-xl shadow-md p-5">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="w-8 h-8 rounded-lg bg-amber-500/20 flex items-center justify-center mb-3 text-amber-400">
                            <Sparkles className="w-4 h-4" />
            ...
            <Link href="/name-generator" className="group relative overflow-hidden rounded-xl bg-[#0f172a] border border-[#1e293b] hover:border-blue-500/50 transition-[transform,border-color,box-shadow] hover:-translate-y-1 hover:shadow-xl shadow-md p-5">
                <div className="flex items-start justify-between">
                    <div>
