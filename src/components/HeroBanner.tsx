            ...
            <div className="relative rounded-[1.25rem] sm:rounded-[1.75rem] p-4 sm:p-7 overflow-hidden border border-amber-500/20 bg-gradient-to-b from-[#161326]/95 to-[#090812]/95 shadow-[0_12px_40px_rgba(150,100,220,0.15)] backdrop-blur-xl group">
                ...
                <div className="text-center z-10 relative">
                    ...
                    <div className="flex items-center justify-center gap-3 sm:gap-4">
                        <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-br from-[#1a2333]/90 to-[#0f1725]/90 border border-emerald-500/20 shadow-inner">
                            ...
                            <span className="text-xs uppercase tracking-wide text-emerald-200/70">{t('home.hero.statAccuracy')}</span>
                        </div>
                        <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-br from-[#1a2333]/90 to-[#0f1725]/90 border border-amber-500/20 shadow-inner">
                            ...
                            <span className="text-xs uppercase tracking-wide text-amber-200/70">{t('home.hero.statSpeed')}</span>
                        </div>
                    </div>

                    <p className="mt-5 text-sm text-emerald-300/80 font-medium tracking-wide">
